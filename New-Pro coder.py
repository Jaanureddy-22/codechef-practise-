...
If errors are present in at least half of the total lines, Ved will be labeled as a NEWBIE.Otherwise, he will be called a PRO After compiling Ved's code, the compiler reported errors in M lines. Determine Ved's skill category based on this evaluation."""
# cook your dish here
